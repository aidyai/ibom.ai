...
document.getElementById('speakerIcon').addEventListener('click', function() {
    ...
    if (textInput.trim() !== '') {
        ...
        document.getElementById('speakerIcon').src = 'static/img/sp3inner.gif';
        ...
        .then(blob => {
            ...
            document.getElementById('speakerIcon').src = 'static/img/play.gif';
            ...
            audioPlayer.addEventListener('ended', function() {
                document.getElementById('speakerIcon').src = 'static/img/play.png';
            });
        })
        .catch(error => {
